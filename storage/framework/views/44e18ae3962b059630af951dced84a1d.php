...
<div style="position:fixed;top:0;left:0;right:0;z-index:50;
  ...
  <a href="<?php echo e(route('welcome')); ?>" style="display:flex;align-items:center;gap:10px;text-decoration:none">
    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Listify logo" style="width:30px;height:30px;display:block" />
...
<?php /**PATH C:\Users\saran\listify\resources\views/layouts/guest.blade.php ENDPATH**/ ?>