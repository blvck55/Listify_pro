...
<?php $component->withAttributes([]); ?>
  <div class="lf-card" style="padding:2.5rem 2rem;box-shadow:var(--shadow-lg)">
    ...
    <div style="text-align:center;margin-bottom:2rem">
      <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Listify" style="width:48px;height:48px;margin:0 auto 1rem;display:block" />
      ...
      <p style="font-size:13px;color:var(--text-secondary)">Sign in to your Listify account</p>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
      <div class="lf-alert lf-alert-danger" style="margin-bottom:1.25rem">
        <i class="fa-solid fa-circle-exclamation"></i> <?php echo e(session('error')); ?>

      </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('google')): ?>
      <div class="lf-alert lf-alert-danger" style="margin-bottom:1.25rem">
        <i class="fa-solid fa-circle-exclamation"></i> <?php echo e($errors->first('google')); ?>
      ...
      <div style="display:flex;flex-direction:column;gap:1.1rem">
        ...
        <div class="lf-form-group">
          ...
          <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>"
                 ...
                 class="lf-input <?php echo e($errors->has('email') ? 'lf-input-error' : ''); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
            <div class="lf-field-error"><i class="fa-solid fa-circle-exclamation"></i> <?php echo e($message); ?></div>
          <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="lf-form-group">
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
              <a href="<?php echo e(route('password.request')); ?>"
                 style="font-size:12px;color:var(--brand);text-decoration:none;font-weight:500">
                Forgot password?
              </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </div>
          <input id="password" name="password" type="password" required
                 ...
                 class="lf-input <?php echo e($errors->has('password') ? 'lf-input-error' : ''); ?>"
                 placeholder="••••••••">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div style="display:flex;align-items:center;gap:8px">
          ...
          <label for="remember_me" style="font-size:13px;color:var(--text-secondary);cursor:pointer">
    ...
    <div style="margin-top:1.25rem">
      <a href="<?php echo e(route('auth.google')); ?>" class="lf-btn lf-btn-outline"
    ...
    <p style="text-align:center;font-size:13px;color:var(--text-secondary)">
      ...
      <a href="<?php echo e(route('register')); ?>" style="color:var(--brand);font-weight:600;text-decoration:none">
        Create one free
      </a>
    </p>
...
<?php endif; ?>
<?php /**PATH C:\Users\saran\listify\resources\views/auth/login.blade.php ENDPATH**/ ?>