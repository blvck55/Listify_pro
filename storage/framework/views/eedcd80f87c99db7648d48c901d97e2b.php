...
<nav class="lf-nav">
  <div class="lf-wrap lf-nav-inner">
    ...
    <div class="lf-nav-right">
      ...
      <a href="<?php echo e(route('login')); ?>" class="lf-btn lf-btn-ghost lf-btn-sm">Sign in</a>
      <a href="<?php echo e(route('register')); ?>" class="lf-btn lf-btn-primary lf-btn-sm">Get started</a>
    </div>
  </div>
</nav>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:4rem;align-items:center">
    ...
    <div>
      ...
      <div style="display:flex;gap:.75rem;flex-wrap:wrap">
        <a href="<?php echo e(route('register')); ?>" class="lf-btn lf-btn-primary lf-btn-lg">
    ...
    <div>
      <div class="lf-card" style="padding:1.5rem;position:relative;overflow:hidden">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:.75rem;margin-bottom:1rem">
          ...
          ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$t, $p, $d, $s]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="lf-task-tile <?php echo e($s === 'completed' ? 'completed' : ''); ?>" style="min-height:100px;padding:1rem">
            <div>
              <div class="lf-task-tile-label">Task</div>
              <div class="lf-task-tile-title" style="font-size:.85rem"><?php echo e($t); ?></div>
            </div>
            <div style="display:flex;align-items:center;justify-content:space-between">
              <span class="lf-pill lf-pill-<?php echo e($p); ?>"><?php echo e($p); ?></span>
              <span class="lf-task-tile-date"><?php echo e($d); ?></span>
            </div>
          </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2rem">
      ...
      <div style="display:flex;flex-direction:column;gap:.75rem">
        <div style="width:44px;height:44px;background:var(--brand-light);border-radius:10px;display:flex;align-items:center;justify-content:center">
          <i class="fa-solid <?php echo e($icon); ?>" style="color:var(--brand);font-size:18px"></i>
        </div>
        <div>
          <div style="font-family:var(--font-head);font-size:1rem;font-weight:700;color:var(--text-primary);margin-bottom:.35rem"><?php echo e($title); ?></div>
          <div style="font-size:13px;color:var(--text-secondary);line-height:1.6"><?php echo e($desc); ?></div>
        </div>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
