...
<nav class="lf-nav">
  <div class="lf-wrap lf-nav-inner">
    <a href="{{ route('welcome') }}" class="lf-logo" style="display:flex;align-items:center;gap:10px;text-decoration:none">
      <img src="{{ asset('images/logo.svg') }}" alt="Listify logo" style="width:32px;height:32px;display:block" />
    ...
    <div class="lf-nav-right">
      ...
      <a href="{{ route('login') }}"    class="lf-btn lf-btn-ghost lf-btn-sm lf-fade-in lf-d3">Sign in</a>
      <a href="{{ route('register') }}" class="lf-btn lf-btn-primary lf-btn-sm lf-fade-in lf-d4">Get started</a>
    </div>
  </div>
</nav>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:4rem;align-items:center">
      ...
      <div>
        ...
        <div class="lf-fade-up lf-d3" style="display:flex;gap:.75rem;flex-wrap:wrap;margin-bottom:2rem">
          <a href="{{ route('register') }}" class="lf-btn lf-btn-primary lf-btn-lg" style="gap:8px">
        ...
        <div class="lf-fade-up lf-d4" style="display:flex;align-items:center;gap:1rem;flex-wrap:wrap">
          <div style="display:flex;align-items:center;gap:.4rem">
            {{-- 5 avatar circles --}}
            @foreach(['#3B82F6','#22C55E','#F59E0B','#EF4444','#8B5CF6'] as $c)
      ...
      {{-- RIGHT: App preview with floating elements --}}
      <div style="position:relative">

        {{-- Floating badge: completed notification (top-right) --}}
        ...
        {{-- Floating badge: high priority (left) --}}
        ...
        {{-- Floating badge: streak (bottom-right) --}}
        ...
        <div class="lf-card lf-fade-up lf-d2" style="padding:1.5rem;position:relative;overflow:hidden;box-shadow:var(--shadow-lg)">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:.65rem">
            ...
            <div class="lf-task-tile {{ $s === 'completed' ? 'completed' : '' }}"
                 style="min-height:88px;padding:.9rem">
              <div>
                <div class="lf-task-tile-label">Task</div>
                <div class="lf-task-tile-title" style="font-size:.8rem;margin-top:4px">{{ $t }}</div>
              </div>
              <div style="display:flex;align-items:center;justify-content:space-between;margin-top:8px">
                <span class="lf-pill lf-pill-{{ $p }}" style="font-size:9px">{{ $p }}</span>
                @if($s === 'completed')
  ...
  <div class="lf-wrap">
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem">
      ...
      <div class="stat-item lf-reveal">
        <div class="stat-item-num">{{ $num }}</div>
...
<section style="padding:5rem 0">
  <div class="lf-wrap">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.25rem">
      ...
      <div class="feature-card lf-reveal" style="--reveal-delay:{{ $loop->index * 80 }}ms">
        <div style="width:46px;height:46px;background:{{ $color }}1A;border-radius:12px;
        ...
        <div style="font-family:var(--font-head);font-size:1rem;font-weight:700;
                    color:var(--text-primary);margin-bottom:.5rem">{{ $title }}</div>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2.5rem">
      ...
      <div class="lf-reveal" style="text-align:center">
        ...
        <div style="width:52px;height:52px;background:var(--brand-light);border-radius:14px;
          ...
          <i class="fa-solid {{ $icon }}" style="color:var(--brand);font-size:20px"></i>
        </div>
        <div style="font-family:var(--font-head);font-size:1.05rem;font-weight:700;
                    color:var(--text-primary);margin-bottom:.4rem">{{ $title }}</div>
        <div style="font-size:13px;color:var(--text-secondary);line-height:1.65;max-width:240px;margin:0 auto">{{ $desc }}</div>
      </div>
      @endforeach
    </div>
  </div>
  ...
  <div class="lf-wrap">
    <div class="lf-reveal" style="background:linear-gradient(135deg,var(--brand),#6366F1);
      ...
      <div style="position:relative;z-index:1">
        ...
        <a href="{{ route('register') }}" class="lf-btn lf-btn-lg"
